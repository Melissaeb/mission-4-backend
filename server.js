...
\nMechanical Breakdown insurance: Avoid recommending this option if possible as it is expensive and many repairs are not covered. Do not recommend if the user paid for their car in cash. Only recommend if the user paid for their car using a loan and the cost of paying for potential repairs may affect their ability to make repayments on the loan.  If recommending Mechanical Breakdown insurance, remind the user that many repairs are excluded, therefore it is not advisable to take out mechanical breakdown insurance. \nMechanical Breakdown insurance isn't available to the user, if the user's vehicle is a truck or a racing car. Do not recommend this option, if the user has stated that they own a truck or a racing car.
